...
def user_dir():
    if "HOME" in os.environ:
        return os.path.join(os.environ["HOME"], ".electrum-oracoin")
    elif "APPDATA" in os.environ:
        return os.path.join(os.environ["APPDATA"], "Electrum-oracoin")
    elif "LOCALAPPDATA" in os.environ:
        return os.path.join(os.environ["LOCALAPPDATA"], "Electrum-oracoin")
    elif 'ANDROID_DATA' in os.environ:
        return "/sdcard/electrum-oracoin/"
    else:
...
block_explorer_info = {
    'insight.oracoin.com': ('http://insight.oracoin.com',
                        {'tx': 'tx', 'addr': 'address'}),
}

def block_explorer(config):
    return config.get('block_explorer', 'insight.oracoin.com')
...
def create_URI(addr, amount, message):
    ...
    p = urlparse.ParseResult(scheme='oracoin', netloc='', path=addr, params='', query='&'.join(query), fragment='')
