...
home = 'C:\\electrum-oracoin\\'

# We don't put these files in to actually include them in the script but to make the Analysis method scan them for imports
a = Analysis([home+'electrum-oracoin',
...
exe = EXE(pyz,
          ...
          a.binaries,
          a.datas,
          name=os.path.join('build\\pyi.win32\\electrum-oracoin', 'electrum-oracoin.exe'),
          debug=False,
          strip=None,
          upx=False,
...
coll = COLLECT(exe,
               ...
               icon=home+'icons/electrum.ico',
               console=False,
               name=os.path.join('dist', 'electrum-oracoin'))
