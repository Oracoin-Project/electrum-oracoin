...
imp.load_module('electrum_oracoin', *imp.find_module('lib'))

from electrum_oracoin import SimpleConfig, Wallet, WalletStorage, format_satoshis
from electrum_oracoin import util
from electrum_oracoin.transaction import Transaction
from electrum_oracoin.bitcoin import base_encode, base_decode
    ...
    content = """
      ...
      <LinearLayout 
        ...
        <TextView
          ...
          android:text="Electrum-Oracoin Authenticator"
...
class Authenticator:
    ...
    def __init__(self):
        global wallet
        self.qr_data = None
        storage = WalletStorage('/sdcard/electrum-oracoin/authenticator')
