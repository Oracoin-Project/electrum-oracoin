import time, electrum_oracoin as electrum, Queue
from electrum_oracoin import Interface, SimpleConfig
from electrum_oracoin.network import filter_protocol, parse_servers
...
def get_peers():
    ...
    q = Queue.Queue()
    interface = electrum.Interface('electrum1.oracoin.com:50002:s', q)
    interface.start()
    i, r = q.get()
