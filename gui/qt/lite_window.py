...
from electrum_oracoin.bitcoin import is_valid
...
import re
import time
from electrum_oracoin.wallet import Wallet, WalletStorage
import webbrowser
import history_widget_lite
import receiving_widget
from electrum_oracoin import util
import datetime

from electrum_oracoin.version import ELECTRUM_VERSION as electrum_version
from electrum_oracoin.util import format_satoshis, age
...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        self.address_input.setPlaceholderText(_("Enter a Oracoin address or contact"))
        ...
        # This removes the very ugly OSX highelectruming, please leave this in :D
        ...
        self.setWindowTitle("Electrum-Oracoin")
    ...
    def the_website(self):
        webbrowser.open("http://electrum-oracoin.space")
...
class ReceivePopup(QDialog):
    ...
    def setup(self, address):
        label = QLabel(_("Copied your Oracoin address to the clipboard!"))
        ...
        self.setWindowTitle("Electrum - " + _("Receive Oracoin payment"))
...
class MiniActuator:
    ...
    def waiting_dialog(self, f):
        ...
        w = QDialog()
        w.resize(200, 70)
        w.setWindowTitle('Electrum-Oracoin')
