#!/usr/bin/env python
#
# Electrum - electrumweight Bitcoin client
...
from electrum_oracoin.i18n import _, set_language
from electrum_oracoin.util import block_explorer, block_explorer_info, block_explorer_URL
from electrum_oracoin.util import print_error, print_msg
...
from electrum_oracoin.bitcoin import MIN_RELAY_TX_FEE, is_valid
from electrum_oracoin.plugins import run_hook

import icons_rc

from electrum_oracoin.util import format_satoshis, format_time, NotEnoughFunds, StoreDict
from electrum_oracoin import Transaction
from electrum_oracoin import mnemonic
from electrum_oracoin import util, bitcoin, commands, Wallet
from electrum_oracoin import SimpleConfig, Wallet, WalletStorage
from electrum_oracoin import Imported_Wallet
...
from electrum_oracoin import ELECTRUM_VERSION
import re
...
from electrum_oracoin.paymentrequest import PR_UNPAID, PR_PAID, PR_EXPIRED
from electrum_oracoin.paymentrequest import PaymentRequest, InvoiceStore, get_payment_request, make_payment_request
...
class ElectrumWindow(QMainWindow):
    ...
    def __init__(self, config, network, gui_object):
        ...
        self.setWindowIcon(QIcon(":icons/electrum-oracoin.png"))
        self.init_menubar()
    ...
    def load_wallet(self, wallet):
        import electrum_oracoin as electrum
        self.wallet = wallet
        ...
        title = 'Electrum-Oracoin %s  -  %s' % (self.wallet.electrum_version, self.wallet.basename())
    ...
    def init_menubar(self):
        ...
        help_menu.addAction(_("&Official website"), lambda: webbrowser.open("http://www.oracoin.com"))
    ...
    def show_about(self):
        QMessageBox.about(self, "Electrum-oracoin",
            _("Version")+" %s" % (self.wallet.electrum_version) + "\n\n" + _("Electrum Oracoin wallet's focus is speed, with low resource usage and simplifying Oracoin. You do not need to perform regular backups, because your wallet can be recovered from a secret phrase that you can memorize or write on paper. Startup times are instant because it operates in conjunction with high-performance servers that handle the most complicated parts of the Oracoin system."))

    def show_report_bug(self):
        QMessageBox.information(self, "Electrum-oracoin - " + _("Reporting Bugs"),
            _("Please report any bugs as issues on github:")+" <a href=\"https://github.com/Oracoin-Project/electrum-oracoin/issues\">https://github.com/Oracoin-Project/electrum-oracoin/issues</a>")
    ...
    def notify(self, message):
        if self.tray:
            self.tray.showMessage("Electrum-oracoin", message, QSystemTrayIcon.Information, 20000)
    ...
    def create_send_tab(self):
        ...
        msg = _('Recipient of the funds.') + '\n\n'\
              + _('You may enter a Oracoin address, a label from your list of contacts (a list of completions will be proposed), or an alias (email-like address that forwards to a Oracoin address)')
        ...
        msg = _('Oracoin transactions are in general not free. A transaction fee is paid by the sender of the funds.') + '\n\n'\
    ...
    def read_send_tab(self):
        ...
        for _type, addr, amount in outputs:
            if addr is None:
                QMessageBox.warning(self, _('Error'), _('Oracoin Address is None'), _('OK'))
                return
            if _type == 'address' and not bitcoin.is_address(addr):
                QMessageBox.warning(self, _('Error'), _('Invalid Oracoin Address'), _('OK'))
                return
            if amount is None:
    ...
    def pay_from_URI(self,URI):
        ...
        try:
            ...
            QMessageBox.warning(self, _('Error'), _('Invalid oracoin URI:') + '\n' + str(e), _('OK'))
            return
            ...
            for is_change in sequences:
                ...
                for address in addr_list:
                    ...
                    if address in self.wallet.frozen_addresses:
                        item.setBackgroundColor(0, QColor('electrumblue'))
    ...
    def new_account_dialog(self, password):
        ...
        e = QLineEdit()
        vbox.addWidget(e)
        msg = _("Note: Newly created accounts are 'pending' until they receive oracoins.") + " " \
    ...
    def read_tx_from_qrcode(self):
        from electrum_oracoin import qrscanner
        try:
    ...
    def export_privkeys_dialog(self, password):
        ...
        defaultname = 'electrum-oracoin-private-keys.csv'
    ...
    def do_export_labels(self):
        ...
        try:
            fileName = self.getSaveFileName(_("Select file to save your labels"), 'electrum-oracoin_labels.dat', "*.dat")
            if fileName:
                with open(fileName, 'w+') as f:
                    json.dump(labels, f)
    ...
    def export_history_dialog(self):
        ...
        vbox = QVBoxLayout(d)
        defaultname = os.path.expanduser('~/electrum-oracoin-history.csv')
    ...
    def settings_dialog(self):
        ...
        from electrum_oracoin.i18n import languages
    ...
    def plugins_dialog(self):
        from electrum_oracoin.plugins import plugins, descriptions, is_available, loader
    ...
    def create_csr(self, alias, challenge, password):
        from electrum_oracoin import x509
        import tlslite
