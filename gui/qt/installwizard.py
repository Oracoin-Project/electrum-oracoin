...
from electrum_oracoin import Wallet, Wallet_2of2, Wallet_2of3
from electrum_oracoin import bitcoin
...
import sys
import threading
from electrum_oracoin.plugins import always_hook
from electrum_oracoin.mnemonic import prepare_seed

MSG_ENTER_ANYTHING    = _("Please enter a wallet seed, a master public key, a list of oracoin addresses, or a list of private keys")
