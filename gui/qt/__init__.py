...
from electrum_oracoin.plugins import run_hook, always_hook
...
class ElectrumGui:
    ...
    def build_tray_menu(self):
        ...
        m.addAction(_("Dark/Electrum"), self.toggle_tray_icon)
        m.addSeparator()
        m.addAction(_("Exit Electrum-Oracoin"), self.close)
    ...
    def main(self, url):
        ...
        self.tray.setToolTip('Electrum-Oracoin')
