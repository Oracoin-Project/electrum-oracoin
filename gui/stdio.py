...
_ = lambda x:x
#from i18n import _
from electrum_oracoin.wallet import WalletStorage, Wallet
from electrum_oracoin.util import format_satoshis, set_verbosity, StoreDict
from electrum_oracoin.bitcoin import is_valid
from electrum_oracoin.network import filter_protocol
...
class ElectrumGui:
    ...
    def __init__(self, config, network):
        ...
        if not storage.file_exists:
            print "Wallet not found. try 'electrum-oracoin create'"
            exit()
    ...
    def do_send(self):
        if not is_valid(self.str_recipient):
            print(_('Invalid Oracoin address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-oracoin setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-oracoin setconfig' to change your settings")
        return True
