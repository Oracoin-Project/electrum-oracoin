...
_ = lambda x:x
#from i18n import _
from electrum_oracoin.util import format_satoshis, set_verbosity
from electrum_oracoin.util import StoreDict
from electrum_oracoin.bitcoin import is_valid

from electrum_oracoin import Wallet, WalletStorage
...
class ElectrumGui:
    ...
    def do_send(self):
        if not is_valid(self.str_recipient):
            self.show_message(_('Invalid oracoincoin address'))
            return
        try:
