...
from electrum_oracoin.util import print_error, InvalidPassword
from electrum_oracoin.bitcoin import is_valid
from electrum_oracoin import WalletStorage, Wallet

Gdk.threads_init()
APP_NAME = "Electrum-Oracoin"
import platform
MONOSPACE_FONT = 'Lucida Console' if platform.system() == 'Windows' else 'monospace'

from electrum_oracoin.util import format_satoshis, parse_URI
from electrum_oracoin.network import DEFAULT_SERVERS
from electrum_oracoin.bitcoin import MIN_RELAY_TX_FEE
...
class ElectrumWindow:
    ...
    def __init__(self, wallet, config, network):
        ...
        title = 'Electrum-Oracoin ' + self.wallet.electrum_version + '  -  ' + self.config.path
        ...
        from electrum_oracoin.util import StoreDict
    ...
    def do_send(self, w, data):
        ...
        if not is_valid(to_address):
            self.show_message( "invalid oracoin address:\n"+to_address)
            return
